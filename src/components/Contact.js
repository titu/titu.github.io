...
export default function Contact() {
  ...
  const onHireMeClick = () => {
    window.open(contactData?.upwork, '_blank');
  };
  ...
  const description =
    'Connect with Abdullah Al Mohammad for senior full-stack product engineering, architecture, frontend leadership, and engagement opportunities.';
  ...
  return (
    <>
      ...
      <section id="contact" className="pages" aria-labelledby="contact-title">
        <div className="el-container">
          <h2 id="contact-title" className="content-title">
            Get In Touch
          </h2>
          <p
            className="description-text pt-10"
          ...
          <div className="pt-10 flex flex-wrap justify-center gap-5">
            ...
            {contactData.upwork && (
              <button
                className="icon-button hireme-button"
